...
namespace Admin_Summary_Tab.Admin
{
    ...
    /// </summary>
    public class Admin_Summary_TabItemManager : ItemManager
    {
        private Admin_Summary_TabUserControl _userControl;
        private Guid _kind;

        #region Constructors

        public Admin_Summary_TabItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            _userControl = new Admin_Summary_TabUserControl();
        ...
        {
            return new Admin_Summary_TabAddUserControl();
        }
        ...
        public override bool ValidateAndSaveUserControl()
        {
            if (CurrentItem != null)
            {
                ...
                Configuration.Instance.SaveItemConfiguration(Admin_Summary_TabDefinition.Admin_Summary_TabPluginId, CurrentItem);
            }
            return true;
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((Admin_Summary_TabAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(Admin_Summary_TabDefinition.Admin_Summary_TabPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(Admin_Summary_TabDefinition.Admin_Summary_TabPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(Admin_Summary_TabDefinition.Admin_Summary_TabPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(Admin_Summary_TabDefinition.Admin_Summary_TabPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(Admin_Summary_TabDefinition.Admin_Summary_TabPluginId, _kind, fqid.ObjectId);
            return item;
        }
